            ...
            .addInterceptor { chain ->
                try {
                    ...
                    val currentToken = cachedToken ?: try {
                        ...
                        android.util.Log.e("VisiteVmFactory", "Erreur lors de la récupération du token", e)
                        null
                    }
                    ...
                    if (response.code == 401) {
                        ...
                        try {
                            ...
                            android.util.Log.e("VisiteVmFactory", "Erreur lors du clear session", e)
                        }
                    }
                    
                    response
                } catch (e: Exception) {
                    android.util.Log.e("VisiteVmFactory", "Erreur dans l'interceptor", e)
